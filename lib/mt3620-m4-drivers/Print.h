...
/// </summary>
/// <param name="handle">Which UART to print the value to.</param>
/// <param name="format">2nd argument must be format string.</param>
/// <param name="args">3rd argument is a variable argument list initialized with va_start.</param>
/// <returns>ERROR_NONE on success, or an error code.</returns>
int32_t UART_vPrintf(UART *handle, const char *format, va_list arg)
